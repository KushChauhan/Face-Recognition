...
face_recognizer.read('C:/Users/Kush/PycharmProjects/Face_Recognition_project/Training_data.yml')
...
def face_detector(img):
    ...
    face_classifier = cv2.CascadeClassifier('C:/Users/Kush/AppData/Local/Programs/Python/Python38-32/Lib/site-packages/cv2/data/haarcascade_frontalface_default.xml')
...
name = {0:'Narendar Modi',1:'Virat Kohli'}
